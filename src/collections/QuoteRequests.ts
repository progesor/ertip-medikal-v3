    ...
    fields: [
        {
            type: 'row',
            fields: [
                { name: 'customerName', type: 'text', label: 'Müşteri / Yetkili Adı', required: true, admin: { width: '50%' } },
                { name: 'company', type: 'text', label: 'Firma / Klinik Adı', admin: { width: '50%' } },
            ]
        },
        {
            type: 'row',
            fields: [
                { name: 'email', type: 'email', label: 'E-Posta Adresi', required: true, admin: { width: '50%' } },
                { name: 'phone', type: 'text', label: 'Telefon Numarası', required: true, admin: { width: '50%' } },
            ]
        },
        { name: 'message', type: 'textarea', label: 'Müşteri Notu / Özel İstekler' },
        {
            name: 'status',
            type: 'select',
            label: 'Talep Durumu',
