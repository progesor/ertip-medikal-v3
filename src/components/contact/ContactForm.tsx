    ...
    if (status?.success) {
        return (
            <div className="p-8 bg-green-50 text-green-800 rounded-2xl border border-green-200 text-center space-y-4">
                ...
                <p className="text-lg">Talebiniz başarıyla bize ulaştı. En kısa sürede sizinle iletişime geçeceğiz.</p>
            </div>
        )
    }
    ...
    return (
        <form action={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <Input id="name" name="name" required placeholder="Adınız ve Soyadınız" disabled={isPending} />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <Label htmlFor="email">E-Posta <span className="text-red-500">*</span></Label>
                    <Input id="email" name="email" type="email" required placeholder="ornek@sirket.com" disabled={isPending} />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="phone">Telefon Numaranız</Label>
                    <Input id="phone" name="phone" type="tel" placeholder="+90 (555) 000 00 00" disabled={isPending} />
                </div>
            </div>

            <div className="space-y-2">
                <Label htmlFor="message">Mesajınız / Teklif Talebiniz <span className="text-red-500">*</span></Label>
                <Textarea
                    id="message"
                    name="message"
                    required
            ...
            <Button type="submit" size="lg" className="w-full text-md" disabled={isPending}>
