                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mt-7 text-center w-full px-2">
                                    <h4 className="font-extrabold text-slate-950 text-lg mb-1.5 line-clamp-2 leading-snug group-hover:text-primary transition-colors">{cert.name}</h4>
                                    {cert.issuer && (
                                        <p className="text-sm text-slate-600 font-semibold uppercase tracking-wider line-clamp-1">{cert.issuer}</p>
                                    )}
                                </div>
                            </div>
                        );
                        ...
                        <div className="lg:col-span-2 p-10 md:p-14 text-white space-y-8 border-t lg:border-t-0 lg:border-l border-slate-800 flex flex-col justify-center">
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-3 text-primary">
                                    ...
                                    <span className="text-sm font-bold uppercase tracking-widest text-primary/80">Sertifika Detayları</span>
                                </div>
                                <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight leading-tight">{currentCert.name}</h3>
                            </div>
                            ...
                            <div className="space-y-6 text-slate-300">
                                ...
                                {currentCert.issuer && (
                                    <div className="flex items-center gap-4 bg-slate-800/30 p-5 rounded-2xl border border-slate-800">
                                        ...
                                        <div>
                                            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider mb-0.5">Düzenleyen Kurum</p>
                                            <p className="text-xl font-bold text-white">{currentCert.issuer}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-slate-400 leading-relaxed">
                                            {currentCert.description || "Bu sertifika, Ertip Medikal'in ilgili standartlara ve kalite yönetmeliklerine uygunluğunu belgelemektedir. Orijinal nüshası şirket merkezimizde muhafaza edilmektedir."}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="pt-6">
                                <Button className="w-full h-14 rounded-full text-md font-bold" variant="outline">
