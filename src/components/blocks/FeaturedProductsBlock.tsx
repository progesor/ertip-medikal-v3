...
export async function FeaturedProductsBlock({
  ...
  return (
    <section className="py-24 bg-surface-subtle border-t border-surface-muted">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
          <div className="max-w-2xl">
            ...
            {/*</div>*/}
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-content-strong mb-4">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="relative aspect-square overflow-hidden bg-surface p-6 flex items-center justify-center"
                >
                  <Image
                    src={imageUrl}
                    alt={product.title}
                  ...
                  {/* SKU Rozeti */}
                  {product.sku && (
                    <div className="absolute top-4 right-4 bg-white text-content text-[10px] px-2.5 py-1 rounded-md font-mono font-bold shadow-sm border border-surface-muted">
                      {product.sku}
                    </div>
                  )}
                </Link>
