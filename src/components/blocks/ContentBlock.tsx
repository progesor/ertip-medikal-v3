  ...
  return (
    <section className="w-full py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        <div
          className="
          text-content leading-relaxed space-y-6
          [&>h2]:text-3xl [&>h2]:font-bold [&>h2]:text-content-strong [&>h2]:mt-12 [&>h2]:mb-6
          [&>h3]:text-2xl [&>h3]:font-semibold [&>h3]:text-content-strong [&>h3]:mt-8 [&>h3]:mb-4
          [&>p]:text-lg
