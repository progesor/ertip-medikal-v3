            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((item: any, index: number) => {
                        ...
                        return (
                            <Card key={index} className="relative border-none bg-slate-50 rounded-[2.5rem] p-4 group hover:bg-slate-100 transition-colors duration-300">
                                    ...
                                    <blockquote className="relative z-10">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-sm text-slate-500 font-medium lowercase">Referans</span>
                                            </div>
                                        </div>
                                    </blockquote>
                                </CardContent>
