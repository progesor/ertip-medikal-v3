  ...
  fields: [
    {
      ...
      options: [
        ...
        {
          label: "Medical Blue (Kurumsal Medikal Mavi)",
          value: "medical-blue",
        },
        {
          label: "Medical Aqua (Mavi & Yeşil Ana Medikal Tema)",
          value: "medical-aqua",
        },
        ...
        {
          label: "Premium Navy (Kurumsal Lacivert & Mavi)",
          value: "premium-navy",
        },
        {
          label: "Surgical Teal (Klinik Teal & Beyaz)",
          value: "surgical-teal",
        },
        { label: "Ruby Premium (Yakut Kırmızısı & Antrasit)", value: "ruby" },
        { label: "Pure Black (Siyah & Premium Kontrast)", value: "pure-black" },
        {
          label: "Graphite Gray (Antrasit & Modern Gri)",
          value: "graphite-gray",
        },
        {
          label: "Platinum Silver (Açık Gri & Premium Klinik)",
        ...
        {
          label: "Royal Indigo (İndigo & Teknolojik Kurumsal)",
          value: "royal-indigo",
        },
        {
          label: "Corporate Steel (Çelik Gri & B2B Teknik)",
          value: "corporate-steel",
        },
        {
          label: "Warm Sand (Sıcak Kum & Premium Katalog)",
          value: "warm-sand",
        },
        { label: "Violet Lab (Mor & Ar-Ge Laboratuvar)", value: "violet-lab" },
        {
          label: "Clean Rose (Kozmetik & Estetik Premium)",
          value: "clean-rose",
        },
      ],
      admin: {
