    ...
    fields: [
        {
            ...
            minRows: 1,
            fields: [
                { name: 'image', type: 'upload', relationTo: 'media', required: false, label: 'Arkaplan Görseli' },
                { name: 'title', type: 'text', label: 'Ana Başlık', required: true },
                { name: 'subtitle', type: 'textarea', label: 'Alt Metin' },
                {
                    type: 'row',
                    fields: [
                        { name: 'buttonText', type: 'text', label: 'Buton Yazısı', admin: { width: '50%' } },
                        { name: 'buttonLink', type: 'text', label: 'Buton Linki', admin: { width: '50%' } },
                    ],
                },
                {
                    name: 'overlayOpacity',
